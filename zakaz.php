                ...
                <div class="container_12">
                  <div class="wrapper">
                    <div class="grid_12">
                      ...
                      <h3 class="prev-indent-bot">Письмо в отдел продаж</h3><br><br>
					  <p style="font-size:16px; margin-left:20px">Если Вы хотите оставить заявку, заполните эту форму. </p>
 <p style="font-size:16px; margin-left:20px"> Пожалуйста, заполните все обязательные поля. Свяжемся с Вами в ближайшее время. </p>
 <p style="font-size:16px; margin-left:20px">Или пишите на почту:  <b>zakaz@idiamarket.kz</b></p>
...
<footer>
 <div class="main">
    <div class="container_12">
       <div class="wrapper">
        <div class="grid_4">
         <div class ="foot">&copy; 2010-2020 MebelCenter.kz</div>
