...
$header .= "From: Новая заявка <sdfsdfsdfsdfddfsfdsfdsdffsd@gmail.com>\n\n";	
$mail = mail("ersultansansyzbaj@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
