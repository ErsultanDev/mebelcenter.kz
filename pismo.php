        ...
        <div class="grid_13">
          <nav>
           <ul class="menu">
			  ...
			  <li><a href="dostavka.html">Доставка</a></li><li><a href="portfolio.html">Наши работы</a></li>
            ...
            <div class="box">
              <div class="padding">
                <div class="container_12">
                  <div class="wrapper">
                    <div class="grid_12">
                      <div class="indent-left p2" style="padding-bottom:0">
					  
                      <h3 class="prev-indent-bot">Письмо руководству</h3><br><br>
					  <p style="font-size:16px; margin-left:20px">Если Вы хотите отправить письмо руководству с предложениями, замечаниями или по вопросам сотрудничества заполните эту форму. </p>
 <p style="font-size:16px; margin-left:20px"> Ваши сообщения напрямую проходят руководству. Пожалуйста, заполните все обязательные поля. Свяжемся с Вами в ближайшее время.  </p>
 <p style="font-size:16px; margin-left:20px">Или пишите на почту:  <b>admin@idiamarket.kz</b></p>
...
<div style="margin-top:5px; float:none"><input type="submit" class="vpb_general_button"  value="Отправить"></div>
</form>		
						  </div>
